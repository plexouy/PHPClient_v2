...
class Query
{
    ...
    /**
     * @param int $query_operator
     * @param int $field
     * @param int $operator
     * @param string $value
     */
    public function __construct(public $QueryOperator = null, public $Field = null, public $Operator = null, public $Value = null, $sub_queries = null) {
        if ($sub_queries) {
    ...
    public function toArray() {
        return [
            ...
            'SubQueries' => array_map(fn($query) => $query->toArray(), $this->SubQueries),
            'Value' => $this->Value,
        ];
    }
}
